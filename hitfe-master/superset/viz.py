...
class ProgressBarCircleViz(BaseViz):

    viz_type = 'progress_bar_circle'
    verbose_name = _('Progress Bar Circle')
    is_timeseries = False
    ...
    def query_obj(self):
        ...
        all_col = self.form_data.get('all_columns')
        if not all_col:
            raise Exception(_('Pick a column!'))
        d['columns'] = all_col
        self.form_data['column'] = all_col
        return d
...
class OperationalParametersViz(BaseViz):

    viz_type = 'operational_parameters'
    verbose_name = _('Operational Parameters')
    is_timeseries = False
    def query_obj(self):
        # print('User Information:', self.form_data['user'])
        d = super(OperationalParametersViz, self).query_obj()
        
        # d['extras']['where'] = "Factory_ID = 'FACT01'"
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
    ...
    def get_data(self, df):
        ...
        return {
            ...
            # 'data': df.values.tolist(),
            'chart_header': form_data.get('chart_header', ''),
        }

class AssetAvatarViz(BaseViz):

    viz_type = 'asset_avatar'
    verbose_name = _('Asset Avatar')
    is_timeseries = False

    def query_obj(self):
        d = super(AssetAvatarViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
...
class ProductionLineMapViz(BaseViz):

    viz_type = 'production_line_map'
    verbose_name = _('Production Line Map')
    is_timeseries = False

    def query_obj(self):
        d = super(ProductionLineMapViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
...
class orderFulfillViz(BaseViz):

    """Annoy visualization Order Fulfillment"""

    viz_type = 'orderFulfill'
    verbose_name = _('Order Fulfillment')
    is_timeseries = False
    
    def query_obj(self):
        d = super(orderFulfillViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
...
class assetLifeInfoViz(BaseViz):

    """Annoy visualization Asset Health Info"""

    viz_type = 'assetLifeInfo'
    verbose_name = _('Asset Health Info')
    is_timeseries = False
    
    def query_obj(self):
        d = super(assetLifeInfoViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
...
class OeeValuesViz(BaseViz):

    viz_type = 'oee_values'
    verbose_name = _('OEE Values')
    is_timeseries = False

    def query_obj(self):
        d = super(OeeValuesViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
...
class FactoryFloorMapViz(BaseViz):

    viz_type = 'factory_floor_map'
    verbose_name = _('Factory Floor Map')
    is_timeseries = False

    def query_obj(self):
        d = super(FactoryFloorMapViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
...
class AlertTableViz(BaseViz):

    viz_type = 'alert_table'
    verbose_name = _('Alert Table')
    is_timeseries = False

    def query_obj(self):
        d = super(AlertTableViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
...
class AlertTableTabViz(BaseViz):

    viz_type = 'alert_table_tab'
    verbose_name = _('Alert Table Tab')
    is_timeseries = False

    def query_obj(self):
        d = super(AlertTableTabViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
...
class FactoryOeeViz(BaseViz):

    viz_type = 'factory_oee'
    verbose_name = _('Factory OEE')
    is_timeseries = False

    def query_obj(self):
        d = super(FactoryOeeViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
...
class FactoryDistributionMapViz(BaseViz):

    viz_type = 'factory_distribution_map'
    verbose_name = _('Factory Distribution Map')
    is_timeseries = False

    def query_obj(self):
        d = super(FactoryDistributionMapViz, self).query_obj()
        # if self.form_data['user']['role'] != 'Admin':
        #     d['extras']['where'] = self.form_data['user']['column_name'] + "='"+ self.form_data['user']['column_value'] + "'"
