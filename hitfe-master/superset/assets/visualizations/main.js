...
export const VIZ_TYPES = {
  ...
  rose: 'rose',
  progress_bar_circle: 'progress_bar_circle',
  operational_parameters: 'operational_parameters',
  asset_avatar: 'asset_avatar',
  production_line_map: 'production_line_map',
  orderFulfill: 'orderFulfill',
  assetLifeInfo: 'assetLifeInfo',
  oee_values: 'oee_values',
  factory_floor_map: 'factory_floor_map',
  alert_table: 'alert_table',
  alert_table_tab: 'alert_table_tab',
  factory_oee: 'factory_oee',
  factory_distribution_map: 'factory_distribution_map',
};
...
const vizMap = {
  ...
  // [VIZ_TYPES.progress_bar_circle]: require('./progress_bar_circle.jsx'),
  [VIZ_TYPES.operational_parameters]:require('./operational_parameters.jsx'),
  [VIZ_TYPES.asset_avatar]:require('./asset_avatar.jsx'),
  [VIZ_TYPES.production_line_map]:require('./production_line_map.jsx'),
  [VIZ_TYPES.orderFulfill]: require('./orderFulfill.js'),
  [VIZ_TYPES.assetLifeInfo]: require('./assetLifeInfo.js'),
  [VIZ_TYPES.oee_values]: require('./oee_values.js'),
  [VIZ_TYPES.factory_floor_map]: require('./factory_floor_map.js'),
  [VIZ_TYPES.alert_table]: require('./alert_table.js'),
  [VIZ_TYPES.alert_table_tab]: require('./alert_table_tab.js'),
  [VIZ_TYPES.factory_oee]: require('./factory_oee.js'),
  [VIZ_TYPES.factory_distribution_map]: require('./factory_distribution_map.js'),
};
