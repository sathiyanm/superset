...
import './production_line_map.css';

function productionLineMapViz(slice, payload) {
    ...
    let vizLabel = payload.form_data.chart_header ? payload.form_data.chart_header : 'Production Line Map';
    let isProdOneEnabled = false;
    let lineId = 'PL02';

    let vizData = {
        "ASST01":["Compressor 1","critical","45.34","critical","20","critical","85","warning","95","normal", 1], 
        "ASST02":["Conveyor Belt 1","warning","75.2","warning","90.2","normal","73","warning","75","warning", 2]
    };
    // {
    //     "ASST03":["Compressor 2","critical","45.34","critical","20","critical","85","warning","95","normal","2"], 
    //     "ASST04":["Conveyor Belt 2","warning","75.2","warning","90.2","normal","73","warning","75","warning","1"],
    //     "ASST05":["CNC 1","critical","45.34","critical","20","critical","85","warning","95","normal","3"], 
    //     "ASST06":["CNC 2","warning","75.2","warning","90.2","normal","73","warning","75","warning","1"],
    //     "ASST07":["CNC 3","critical","45.34","critical","20","critical","85","warning","95","normal","2"], 
    //     "ASST08":["Robotic Arm 1","warning","75.2","warning","90.2","normal","73","warning","75","warning","4"]
    // };

    
    
    var assetLength = json.length;
    if(assetLength > 0){
    ...
    function dataObj(json){
        ...
        for (var i=0; i<assetLength; i++){
            ...
            var PodLineMapCount = "";
            if(json[i].Asset_Status == "Critical"){
                PodLineMapCount = json[i].Alert_Critical_Count
            }else if(json[i].Asset_Status == "Warning"){
                PodLineMapCount = json[i].Alert_Warning_Count
            }

            _data[json[i].Asset_ID] = [
                json[i].Asset_Name, json[i].Asset_Status.toLowerCase(), 
                json[i].OEE_Percentage, json[i].OEE_Status.toLowerCase(), 
                json[i].Availability_Percentage, json[i].Availability_Status.toLowerCase(), 
                json[i].Performance_Percentage, json[i].Performance_Status.toLowerCase(), 
                json[i].Quality_Percentage, json[i].Quality_Status.toLowerCase(), 
                PodLineMapCount];

            if(json[i].Line_ID == 'PL01'){
                lineId = 'PL01';
    ...
    class ProdLine extends React.Component {
        ...
        constructor(props) {
            ...
            this.state = {
                prodLineID: lineId,
                isProdOneEnabled: isProdOneEnabled,
                assets : vizData,
            };
        }
        ...
        handleLoad(){
            ...
            var assets = $(".asset"),
                ...
                assets.each(function(i, asset){
                    ...
                    $(asset).find(".assetSelect").removeClass("critical warning normal").addClass(_data[1]);
                    $(asset).find(".roundMarker").removeClass("critical warning normal").addClass(_data[1]);
                    if(_data[1] != "normal"){
                        $(asset).find(".roundMarker span").html(_data[10]);
                    }else{
                        $(asset).find(".roundMarker span").html(0);
                    }
                });
                assets.hover(function(e){
                    ...
                    var curObject = $(e.target).parent(),
                        ...
                        infoCard.find(".selected .rightsection .availability .percBar").removeClass("critical warning normal").addClass(_data[5]); // Criticality of Availability
                        ...
                        infoCard.find(".selected .rightsection .performance .percBar").removeClass("critical warning normal").addClass(_data[7]); // Criticality of Availability
                        ...
                        infoCard.find(".selected .rightsection .quality .percBar").removeClass("critical warning normal").addClass(_data[9]); // Criticality of Availability
                    ...
                    queryParam = queryParam + "ast=" + $(this).data("assetid");
                    window.location.href = '/superset/dashboard/asset/?' + queryParam;
                    
                    // var formElement = '<form method="get" action="/superset/dashboard/asset/">' +
                    // '<input type="hidden" name="ast" value="'+ $(this).data("assetid") +'"/>' + 
                    // '</form>';
            ...
            return (
                ...
                { !this.state.isProdOneEnabled
                        ? <div className="innerImage">
                            <img src="/static/assets/images/prd01.png" className="prodLineImage"/>                    
                            <div className="asset compressorOne"  data-assetid="ASST01">
                            ...
                            <div className="asset conveyorBeltOne"  data-assetid="ASST02">
                                <div className="assetHover">
                                    <div className="roundMarker">
                                        <div className="arrow bottom"></div>
                                        <span>&nbsp;</span>
                        ...
                        : <div className="innerImage">
                            <img src="/static/assets/images/prd02.png" className="prodLineImage"/>                    
                            <div className="asset compressorTwo"  data-assetid="ASST03">
                                <div className="assetHover">
                                    <div className="roundMarker">
                                        <div className="arrow bottom"></div>
                                        <span>&nbsp;</span>
                            ...
                            <div className="asset conveyorBeltTwo"  data-assetid="ASST04">
                                <div className="assetHover">
                                    <div className="roundMarker">
                                        <div className="arrow bottom"></div>
                                        <span>&nbsp;</span>
                            ...
                            <div className="asset cncOne"  data-assetid="ASST05">
                                <div className="assetHover">
                                    <div className="roundMarker">
                                        <div className="arrow bottom"></div>
                                        <span>&nbsp;</span>
                            ...
                            <div className="asset cncTwo"  data-assetid="ASST06">
                                <div className="assetHover">
                                    <div className="roundMarker">
                                        <div className="arrow bottom"></div>
                                        <span>&nbsp;</span>
                            ...
                            <div className="asset cncThree"  data-assetid="ASST07">
                                <div className="assetHover">
                                    <div className="roundMarker">
                                        <div className="arrow bottom"></div>
                                        <span>&nbsp;</span>
    ...
    ReactDOM.render(<ProdLine />, container);
    
}


module.exports = productionLineMapViz;
...
// </svg>
// <div className="asset roboarmOne"  data-assetid="ASST08">
//     <div className="assetHover">
//         <div className="roundMarker">
//             <div className="arrow bottom"></div>
//             <span>&nbsp;</span>
