...
export const visTypes = {
  ...
  operational_parameters: {
    label: t('Operational Parameters'),
    requiresTime: false,
    controlPanelSections: [
      {
        label: t('Query'),
  ...
  factory_distribution_map: {
    label: t('Factory Distribution Map'),
    requiresTime: false,
    controlPanelSections: [
      {
        label: t('Query'),
