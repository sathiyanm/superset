...
export const controls = {
  ...
  progress_bar_label: {
    type: 'TextControl',
    label: t('Label Text'),
    description: t('Description text for which parameter progess bar will display'),
  },

  stroke_width:{
    type: 'TextControl',
    label: t('Stroke Width'),
    description: t('Should be in number - by default it will take 2'),
  },

  trail_width:{
    type: 'TextControl',
    label: t('Trail Width'),
    description: t('Should be in number - by default it will take 1.5'),
  },

  chart_header: {
    type: 'TextControl',
    label: t('Chart Header'),
    description: t('Header text to display above the chart'),
  },
