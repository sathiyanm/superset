...
export function getInitialState(bootstrapData) {
  const { user_id, user_role, dashboard_id, datasources, common } = bootstrapData;
  ...
  return {
    charts: initCharts,
    dashboard: { filters, dashboard, userId: user_id, userRole: user_role, dashboardId: dashboard_id, datasources, common, editMode: false },
  };
}
